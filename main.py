...
def get_slot_machine_spin(rows, cols, symbols):
    # Create all symbols list
    all_symbols = []
    for symbol, symbol_count in symbols.items():
        for _ in range(symbol_count):
            all_symbols.append(symbol)
    
    # Create a 3 * 3 list to present the symbols of slt
    columns = []    
    for _  in range(cols):
        column = []
...
def deposit():
    while True:
        ...
        if amount.isdigit():
            ...
            print("Please enter a number to deposit.")
    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if 1 <= lines <= MAX_LINES:
                ...
                print(f"Enter a valid number between 1 and {MAX_LINES} lines.")
        else:
